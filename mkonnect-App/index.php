         ...
         <form class="form-vertical" action="login.php" method="POST" id="">
            ...
            <input class="form-control" name="password" placeholder="Your Password" type="password" id="password1"  required="">
                ...
                <div class="popover-footer" id="login4">
                   <center> <input type="submit" name="login" value="Login" class="btn btn-lg btn-primary btn-lg"></input></center>
                </div>

                </form>
  
  <center><p class="text-warning">Don't have an account?</p></center>
   <center><p class="text-success"><a data-toggle="collapse" href="#reg" aria-expanded="false" aria-controls="collapseExample"> Register</a></p></center>
...
<div class="thumbnail">
        ...
        <legend><h1 style="text-align: center;"><i class="fa fa-registered" aria-hidden="true" fa-5x aria-hidden="true"></i></h1></legend>
         <form class="form-vertical" action="register.php" method="POST" id="">
                 <div class="form-group">
            <div class="col-md-12">
               <label for="txt_email" class="control-label">
               <h3 class="text-muted">Email</h3></label>
