              ...
              <div class="col-md-2">
                <div class="list group" style="width:90%; padding:3%; font-size:1.9em;">
                  <ul class="list-group" >
                    ...
                    <li class="list-group-item"><a href="artiste.php"> <i class="glyphicon glyphicon-user"></i>Skiza Artistes</a></li>
                    <li class="list-group-item"><a href="songviews.php"> <i class="glyphicon glyphicon-music"></i>Song views</a></li>
                    <li class="list-group-item"><a href="albumnviews.php"> <i class="glyphicon glyphicon-th-list"></i>Albumn views</a></li>
