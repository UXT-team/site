...
include('header.php');
 ?>
     ...
     $select_query = "select * from engineer WHERE email='".$user_email."'";
         ...
         // $mail_exist= "<script>$('#thankyouModal').modal('show')</script>";
          ...
          echo $mail_exist;
           ...
           echo $redirect;
            ...
            //insert into db
  $insert_query = "insert into ict (name,email,phonenumber,job_type,password) VALUES ('$user_name','$user_email','$user_num','$user_job',md5('$user_pass'))";
