...
class uxtsms {
	...
	public function queue_sms($recipient, $message, $sender, $serviceid, $linkid = "", $scheduled_date = "")
	{
		...
		$this->sms_messages .= "<serviceid>" . $serviceid . "</serviceid>";
		$this->sms_messages .= "<linkid>" . $linkid . "</linkid>";
	...
	public function send_sms_bulk()
	{
		$this->api_url = "send_sms_bulk";
		$this->api_parameters = '&messages=' . urlencode("<request>" . $this->sms_messages . "</request>");
		$this->execute();
	}
	...
	function execute()
	{
		...
		$this->api_url = "http://sms.uxt.co.ke/api/" . $this->api_url; 
		$this->api_parameters = 'api_key=' . urlencode($this->api_key) . $this->api_parameters;
